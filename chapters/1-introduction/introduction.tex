...
The solution involved maintaining a set of linked lists, which shared a lot of
redundant information. This project presents a way to exploit this redundant 
...
More recent regex engines, such as the PikeVM that we study in this project,
