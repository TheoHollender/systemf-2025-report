\begin{center}
    \begin{tabular}{c c}
        \begin{tikzpicture}
            ...
            \draw[->] (root) --node[pos=0.2, above] (a) {$a$} (1, 0);
            \draw[->] (-1,0) -- (root);
        \end{tikzpicture} & \begin{tikzpicture}
            \node[draw] (e1) at (0, 0) {$e_1$};
            \node[draw] (e2) at (1, 0) {$e_2$};
            \draw[->] (-1, 0) -- (e1);
            \draw[->] (e1) -- (e2);
            \draw[->] (e2) -- (2, 0);
        \end{tikzpicture} \\
        ...
        \end{tikzpicture} & \begin{tikzpicture}
            ...
            \draw[->] (-1, 1) -- (root);
            \draw[->] (root) -- (1, 1);
            \draw[->] (root) to[bend right] (e);
            \draw[->] (e) to[bend right] (root);
        \end{tikzpicture}
    \end{tabular} \\ \vspace{0.3ex}
    \textit{NFA constructions for $a, e_1e_2, e_1 \ | \ e_2$ and $e^*$}
\end{center}